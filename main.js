  ...
  // --- Turrell chamber palettes ---
  // Each chamber is a James Turrell-inspired field of color. The level
  // crossfades between chambers as the player scores.
  const CHAMBERS = [
  ...
  function chamberFor(score) {
    // Smoothly transition every 5 points, loop after the last.
    const idx = (score / 5);
